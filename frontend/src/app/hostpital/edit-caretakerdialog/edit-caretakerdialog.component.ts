...
@Component({
  selector: "app-edit-caretakerdialog",
  templateUrl: "./edit-caretakerdialog.component.html",
  styleUrls: ["./edit-caretakerdialog.component.scss"],
})
export class EditCaretakerdialogComponent implements OnInit {
  isLive = [
    { value: true, name: "Yes" },
    { value: false, name: "No" },
  ];
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<EditCaretakerdialogComponent>,
  ...
  update() {
    this.commonServ
      .updateCaretaker(this.form.value, this.data.caretaker_user_id)
      .subscribe(
        (data: any) => {
          if (data.code === 200) {
